...
public JToolBar toolbar;
    ...
    public UIManager(CombatSimulator simulator, BattleReportWindow battlereportwindow) {
        ...
        frame.setLayout(new BorderLayout());
                this.toolbar = new JToolBar("Applications");

        JButton btnCalendar = new JButton(new ImageIcon("line.png"));
        ...
        JButton btnClock = new JButton(new ImageIcon("circle.png"));
        ...
        JButton btnMail = new JButton(new ImageIcon("polygon.png"));
        ...
        JButton btnPhone = new JButton(new ImageIcon("polyline.png"));
    ...
    public void setupUI() {
        ...
        JMenuItem overlaytItem = new JMenuItem("Overlay");
        
      overlaytItem.addActionListener(e -> {

           OverlayApp overlayApp = new OverlayApp();
            repaint();
            overlayApp.setVisible(true);
        });
